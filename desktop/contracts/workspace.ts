...
export const DESKTOP_WORKSPACE_SCHEMA_VERSION = 1 as const;
export const DESKTOP_WORKSPACE_CONTRACT_VERSION =
  "desktop-workspace-v1" as const;
export const DESKTOP_LAYOUT_VERSION = 1 as const;
export const DESKTOP_INTEGRATION_VERSION = 1 as const;
export const DESKTOP_MANAGED_FILES_CONTRACT_VERSION =
  "desktop-managed-files-v1" as const;
