...
const SCRIPTS = Object.freeze({
  ...
  "browser:prepare": "axmorf browser prepare",
  web: "axmorf web",
  preview: "axmorf preview",
  dev: "axmorf dev",
  compositions: "remotion compositions src/index.ts",
  "project:create": "axmorf project create",
  "project:create:context": "axmorf project create context",
  "catalog:query": "axmorf catalog query",
  ...
  "project:attempt:interrupt-inspect":
    "axmorf project attempt interrupt-inspect",
  "project:attempt:interrupt": "axmorf project attempt interrupt",
