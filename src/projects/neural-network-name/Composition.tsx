// @generated-by production-global-visual-scaffold-v4
...
if (productionRequirements.schemaVersion !== 4) throw new Error("Production Preview requires v4 GlobalVisual requirements.");
...
const expectedStoryId = "neural-network-name";
...
export default NeuralNetworkNameComposition;
