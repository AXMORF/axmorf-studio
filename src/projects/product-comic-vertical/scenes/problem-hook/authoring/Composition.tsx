...
const storyBeat = story.beats.find(({meaningId}) => meaningId === "problem-hook");
if (storyBeat === undefined) {
  throw new Error("problem-hook StoryBeat is missing.");
}

const durationInFrames = task.timingBeat.endFrame - task.timingBeat.startFrame;

export const ProblemHookAuthoringComposition: FC = () => {
  ...
  return (
    <AbsoluteFill>
      ...
      <Sequence from={314} durationInFrames={11} layout="none">
        <Audio
          src={staticFile(
            "projects/product-comic-vertical/scene-audio/problem-hook/identity-break-pulse.wav",
          )}
          volume={0.3}
        />
      </Sequence>
...
export default ProblemHookAuthoringComposition;
