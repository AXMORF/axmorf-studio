...
import { createM6PackageInput } from "./scene/m6-package-input";

export const createIsolatedM6Project = async () => {
  const rootDir = await mkdtemp(join(tmpdir(), "rsp-m6-project-"));
...
export const assertM6ProtectedStateUnchanged = async (
  fixture: Awaited<ReturnType<typeof createIsolatedM6Project>>,
) => {
...
export const disposeIsolatedM6Project = async (
  fixture: Awaited<ReturnType<typeof createIsolatedM6Project>>,
