...
test("M9 GlobalVisual is a vertical project-local product-comic continuity treatment", async () => {
  ...
  assert.deepEqual([plan.width, plan.height, plan.durationInFrames], [1080, 1920, 5116]);
