...
if (storyBeat === undefined) {
  throw new Error("core-capabilities StoryBeat is missing.");
}

const durationInFrames = task.timingBeat.endFrame - task.timingBeat.startFrame;

export const CoreCapabilitiesAuthoringComposition: FC = () => {
  ...
  return (
    <AbsoluteFill>
      ...
      <Sequence from={324} durationInFrames={13} layout="none">
        <Audio
          src={staticFile(
            "projects/product-comic-vertical/scene-audio/core-capabilities/authority-stack-chime.wav",
          )}
          volume={0.28}
        />
      </Sequence>
...
export default CoreCapabilitiesAuthoringComposition;
