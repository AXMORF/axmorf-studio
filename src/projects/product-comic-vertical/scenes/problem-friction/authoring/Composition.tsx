...
if (storyBeat === undefined) {
  throw new Error("problem-friction StoryBeat is missing.");
}

const durationInFrames = task.timingBeat.endFrame - task.timingBeat.startFrame;

export const ProblemFrictionAuthoringComposition: FC = () => {
  ...
  return (
    <AbsoluteFill>
      ...
      <Sequence from={316} durationInFrames={9} layout="none">
        <Audio
          src={staticFile(
            "projects/product-comic-vertical/scene-audio/problem-friction/drift-warning-tick.wav",
          )}
          volume={0.28}
        />
      </Sequence>
...
export default ProblemFrictionAuthoringComposition;
