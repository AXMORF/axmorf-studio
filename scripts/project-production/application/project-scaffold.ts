...
export const ensureProjectAuthoringBuildScaffold = async ({
  ...
  if (mode === "check") {
    if (current !== expected)
      throw new Error("Project Composition generated bytes are stale.");
