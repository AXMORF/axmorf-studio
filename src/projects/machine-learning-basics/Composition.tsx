...
const expectedStoryId = "machine-learning-basics";
...
const MachineLearningBasicsComposition: FC<StoryCompositionProps> = (props) => (
  <CompositionAssembly
...
export default MachineLearningBasicsComposition;
