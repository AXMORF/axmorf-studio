...
if (storyBeat === undefined) {
  throw new Error("workflow-result StoryBeat is missing.");
}

const durationInFrames = task.timingBeat.endFrame - task.timingBeat.startFrame;

export const WorkflowResultAuthoringComposition: FC = () => {
  ...
  return (
    <AbsoluteFill>
      ...
      <Sequence from={356} durationInFrames={10} layout="none">
        <Audio
          src={staticFile(
            "projects/product-comic-vertical/scene-audio/workflow-result/evidence-stamp.wav",
          )}
          volume={0.28}
        />
      </Sequence>
...
export default WorkflowResultAuthoringComposition;
