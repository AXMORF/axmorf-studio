...
| [contracts/NARRATIVE_CONTRACTS.md](contracts/NARRATIVE_CONTRACTS.md) | 已实现的 M1/M2 叙事合同、封存与时间算法参考                 |
...
`src/remotion/catalog/`、`src/remotion/runtime/` 与 `.agents/skills/` 当前仅为后续实现预留目录；
M2 没有实现 NarrativeCore、ProjectRegistry、Story Composition 或 Scene runtime。
