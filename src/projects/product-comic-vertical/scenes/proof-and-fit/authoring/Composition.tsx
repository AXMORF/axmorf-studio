...
if (storyBeat === undefined) throw new Error("proof-and-fit StoryBeat is missing.");

const durationInFrames = task.timingBeat.endFrame - task.timingBeat.startFrame;

export const ProofAndFitAuthoringComposition: FC = () => {
  ...
  return (
    <AbsoluteFill>
      ...
      <Sequence from={390} durationInFrames={11} layout="none">
        <Audio
          src={staticFile(
            "projects/product-comic-vertical/scene-audio/proof-and-fit/handoff-confirm.wav",
          )}
          volume={0.3}
        />
      </Sequence>
...
export default ProofAndFitAuthoringComposition;
