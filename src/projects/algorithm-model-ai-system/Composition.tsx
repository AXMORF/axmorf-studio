...
const expectedStoryId = "algorithm-model-ai-system";
...
const AlgorithmModelAiSystemComposition: FC<StoryCompositionProps> = (props) => (
  <CompositionAssembly
...
export default AlgorithmModelAiSystemComposition;
