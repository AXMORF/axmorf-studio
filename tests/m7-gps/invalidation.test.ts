...
import packageJson from "../../src/projects/gps-relativity/scenes/net-drift/generated/scene-package.generated.json";

test("GPS Scene visual and sound invalidation layers stay separated", () => {
